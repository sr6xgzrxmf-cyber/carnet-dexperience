...
function buildDaPrompt(it: Item) {
  const scene = (it.brief ?? "").trim();
  return `
Tu es directeur artistique pour mon site “Carnet d’expérience”.
...
${scene || "(brief manquant : renseigne it.brief dans l’audit)"}`
  .trim();
}
            ...
            <div style={{ display: "grid", gap: 10 }}>
              ...
              <div>
                ...
                <button
                  ...
                  type="button"
                >
                  {copiedKey === `da:${selected.slug}` ? "Copié ✓" : "Copier le prompt DA"}
                </button>
